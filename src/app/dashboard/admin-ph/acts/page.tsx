const ACTS = [
  { date: "20 Dic 2025", assembly: "Ordinaria 2025", status: "Final" },
  { date: "15 Nov 2025", assembly: "Extraordinaria", status: "Final" },
  { date: "10 Oct 2025", assembly: "Extraordinaria", status: "Final" },
];
  ...
  return (
    <div className="card">
      <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", alignItems: "center" }}>
        <div style={{ flex: 1 }}>
          <h2 style={{ marginTop: 0 }}>Actas</h2>
          <p className="muted" style={{ marginTop: "6px" }}>
            Actas digitales generadas automaticamente.
          </p>
        </div>
      ...
      <div className="card-list" style={{ marginTop: "18px" }}>
        {ACTS.map((act) => (
          <div key={act.date} className="list-item" style={{ alignItems: "center" }}>
            <div style={{ flex: 1 }}>
              <strong>{act.assembly}</strong>
              <div className="muted" style={{ fontSize: "12px" }}>
                {act.date} · Estado {act.status}
              </div>
            </div>
